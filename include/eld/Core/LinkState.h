...
//===----------------------------------------------------------------------===//
//
// LinkState defines the link states. These stages break down the overall link
// operation into well-defined phases. The primary role of LinkState is to
// specify which actions linker plugins are allowed to perform at a given point
// in the link.
//
//===----------------------------------------------------------------------===//
