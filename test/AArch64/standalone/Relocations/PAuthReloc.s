...
##                                                     ^^^^ Discr = 47
##                                                           ^^ Key = DA
# HEX-NEXT: {{0x[0-9A-F]+}} 00000000 30000020 00000000 31000020 ....0.. ....1..
##                          ^^^^^^^^ No implicit val (rela reloc)
##                                   ^^^^ Discr = 48
##                                         ^^ Key = DA
...
##                                                     ^^^^ Discr = 49
##                                                           ^^ Key = DA
# HEX-NEXT: {{0x[0-9A-F]+}} 00000000 32000000 77000000 00330000 ....2...w....3..
##                          ^^^^^^^^ No implicit val (preemptible abs reloc)
##                                   ^^^^ Discr = 50
##                                         ^^ Key = IA
##                                            ^^ padding byte
##                                              ^^^^^^ ^^ No implicit val (rela reloc)
##                                                       ^^^^ Discr = 51
# HEX-NEXT: {{0x[0-9A-F]+}} 20770000 00003400 0020               w....4..
##                          ^^ Key = DA
##                            ^^ padding byte
##                              ^^^^ ^^^^ No implicit val (rela reloc)
##                                       ^^^^ Discr = 52
