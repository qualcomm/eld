...
# ERROR-RANGE: Error:     {{.*}}rv32.o:(.text): relocation R_RISCV_BRANCH out of range: 4096 is not in [-4096, 4095]; references '--defsym foo'
# ERROR-RANGE: Error: {{.*}}rv32.o:(.text+0x4): relocation R_RISCV_BRANCH out of range: -4098 is not in [-4096, 4095]; references '--defsym bar'
