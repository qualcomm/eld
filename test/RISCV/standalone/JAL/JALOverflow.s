...
# FAILPOS: Error: {{.*}}.o:(.text): relocation R_RISCV_JAL out of range: 1048576 is not in [-1048576, 1048575]; references '--defsym foo'
# FAILNEG: Error: {{.*}}.o:(.text): relocation R_RISCV_JAL out of range: -1048578 is not in [-1048576, 1048575]; references '--defsym foo'
